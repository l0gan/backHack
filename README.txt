...
command:  ./backHack.sh <package name>  (i.e.  ./backHack com.king.candycrushsaga)

Use at your own risk!!

Will be creating a python script to do the same thing, with menus and all at a later time.
